...
res.pair <- dm_pair(
   ...
   marker1 = "Immune.phenotype", m1.cat.pos = "inflamed", m1.cat.neg = "excluded",
   #marker2 = "TMB",
   marker2 = "gep_TAPBP"
...
res.dm.logit.gepscore <- dm_searchM2_logit(
   ...
   response.neg = "SD/PD", 
    # marker1
   marker1 = "Immune.phenotype", m1.binarize = T, m1.cat.pos = "inflamed", m1.cat.neg = "excluded",
    # marker2
...
res.dm.logit <- dm_searchM2_logit(
   ...
   m2.cat.pos = "YES", 
   m2.cat.neg = "NO")
dm_searchM2_topPlot(res.dm.logit, 20)
```
