...
You can install the released version of dualmarker from github with: devtools::install_github("maxiaopeng/dualmarker")
...
## overall
*Dualmaker* is designed to facilitate the data mining of dual biomarkers. It provides intuitive visualizations and extensive assessment of two marker combinations using logistic regression model for binary response outcome and Cox models for survival analysis. ![man/figures/dualmarker_overview.png]
...
the overall plot:
![man/figures/dualmarker_pair_plot.png]
...
plot1: single markers for response, not shown here
plot2: scatter chart for response, not shown here
plot3: Four-quadrant response rate, not shown here
plot4: ROC curve, not shown here
plot5: single marker for survival
